...
Pony is a modules set, which make Perl more comfirtable for modern development.
...
=item Pony::Object
    ...
    # Now Pony is not need any unusual modules.
...
=head2 More info about each module
